...
import dappFundAbi from '@/artifacts/contracts/happyFund.sol/happyFund.json'
...
const getEthereumContracts = async () => {
  ...
  if (accounts?.length > 0) {
    ...
    const contracts = new ethers.Contract(address.happyFundContract, dappFundAbi.abi, signer)
